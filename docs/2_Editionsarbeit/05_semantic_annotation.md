...
## 1. Standardlösungen für semantisches Annotieren
Die inhaltliche Annotation kann idealerweise in der gleichen Plattform wie die Kommentierung gemacht werden, eine genaue Betrachtung des Digitalisats ist für beide Arbeitsschritte nicht mehr nötig. Transkriptionstools wie Transkribus bieten diese Arbeitsschritte nicht an, d.h. sie weisen bislang nicht die Möglichkeit auf, semantische Annotationen oder Kommentare zu erstellen.
...
## 2. Standard-Workflow-Schritte für die semantische Annotation im TEI-Publisher
