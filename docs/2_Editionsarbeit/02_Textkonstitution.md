...
!!! note "Erfahrung aus der Showcase-Edition"
    ...
    Um den Zugang zu den Bilddaten für alle Projekmtitarbeitenden remote sicherzustellen und die Seiten Transkribus und dem TEI Publisher zuzuweisen, wurde ein [GitLab-Seite für die Bild-Metadaten erstellt](https://gitlab.uzh.ch/digital-editions/proto4diged/image-metadata). 
