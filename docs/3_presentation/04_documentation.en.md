...
For the complete [*archiving of DSE*](../4_longterm_preservation/03_archiving_data.en.md) in repositories, the documentation can also be stored as a separate file (e.g. PDF), such as [here in swissubase](https://www.swissubase.ch/de/catalogue/studies/20701/19845/datasets/2556/3065/overview){:target="\_blank"}.
