...
Das [**internationale Institut für Dokumentologie und Editorik i-d-e**](https://www.i-d-e.de){:target="\_blank"} kann als Anlaufstelle für verschiedene Fragestellungen dienen und führt eine [Liste ihrer Kooperationspartnerschaften](https://www.i-d-e.de/aktivitaeten/kooperationen/){:target="\_blank"} und [Mitglieder](https://www.i-d-e.de/uber-uns-about-us/mitglieder/){:target="\_blank"}.

Mit i-d-e verbunden ist die Fachzeitschrift [RIDE](https://ride.i-d-e.de){:target="\_blank"}, _A review journal for digital editions and resources_, die regelmäßig Rezensionen zu Digitalen Editionen und ähnlichen DH Themen publiziert.

#### Österreich

Eine Übersicht zu mehrheitlich österreichischen Institutionen bietet das [KONDE Weißbuch](https://www.digitale-edition.at/archive/objects/context:konde/methods/sdef:Context/get?mode=themes#T10){:target="\_blank"}.
...
!!! note "Erfahrung aus der Vorstudien-Edition"
    Das vorliegende Projekt hat von Anfang an eine Enge Zusammenarbeit mit dem ZDE gepflegt und dadurch viele Anregungen für die Vorstudien-Edition durch die Vernetzung mit laufenden DSE-Projekten schöpfen können. Auch die Teilnahme und Vernetzung an DSE-spezifischen Tagungen wie ["Open up DSE"](https://www.zde.uzh.ch/de/news/2024/openupdse.html){:target="\_blank"} haben das Projekt wesentlich vorangebracht.
...
-   [DARIAH-CH](https://www.dariah.ch/){:target="\_blank"}: Der Schweizer Knoten der pan-europäischen Forschungsinfrastruktur Digital Research Infrastructure for Arts and Humanities.
